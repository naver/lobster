...
const docTemplate = `{
    ...
    "paths": {
        "/api/v1/namespaces/{namespace}/sinks/{name}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "sink type (logMetricRules, logExportRules)",
                        "name": "type",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/namespaces/{namespace}/sinks/{name}/rules/{rule}": {
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "deprecated;metric rule name to delete",
                        "name": "ruleName",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "deprecated;bucket name to delete",
                        "name": "bucketName",
                        "in": "query"
                    }
                ],
        ...
        "/api/v1/namespaces/{namespace}/sinks/{name}/{type}": {
            "get": {
                "produces": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "deprecated;sink type (logMetricRules, logExportRules)",
                        "name": "type",
                        "in": "path"
                    },
                    {
