// Package global_query Code generated by swaggo/swag. DO NOT EDIT
...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/{version}/logs/export": {
            "post": {
                "description": "Export logs for conditions",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "Export logs within range",
                "parameters": [
                    {
                        "type": "string",
                        "description": "v1 or v2",
